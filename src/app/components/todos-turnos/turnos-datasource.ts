...
export class TurnosDataSource extends DataSource<Turno>
{
   ...
   */
  private getPagedData(data: Turno[]): Turno[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Turno[]): Turno[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'email_esp': return compare(a.users.firstname, b.users.firstname, isAsc);
        case 'email_paciente': return compare(a.users.firstname, b.users.firstname, isAsc);
